...
public class LevelBuilder {
    ...
    public static ArrayList<Drawable> getWalls(int level, GameActivity_Layout game) {
        ...
        if(level == 2) {
            ...
            walls.add(new Wall(200, 1300, 900, 1500,game));
            //Above huge bottom structure
            walls.add(new Wall(150, 900, 900, 1100,game));
            //Above previous wall
            walls.add(new Wall(0, 600, 400, 700,game));
            //Above previous wall
            walls.add(new Wall(0, 300, 775, 400,game));
            //Right of previous wall
            walls.add(new Wall(500, 300, 775, 700,game));
            //Left Wall
            walls.add(new Wall(0, 0, 50, 1500, game));
            //Right Wall
...
//            Above lower spikes
    ...
    public static ArrayList<Drawable>getPlates(int level, GameActivity_Layout game, List<Drawable> doors) {
        ...
        if(level == 2) {
            plates.add(new Plate(50, 588, game, (Door)doors.get(0)));
        }
        if(level == 3) {
    ...
    public static ArrayList<Drawable>getDoors(int level, GameActivity_Layout game) {
        ...
        if(level == 2) {
            doors.add(new Door(772, 500, game));
        }
        if(level == 3) {
